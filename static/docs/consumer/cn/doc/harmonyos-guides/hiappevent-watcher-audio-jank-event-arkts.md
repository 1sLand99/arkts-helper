...
以实现对应用音频播放触发丢帧生成的音频卡顿事件订阅为例，说明开发步骤。
  ...
  1. 编辑工程中的“entry > src > main > ets > entryability > EntryAbility.ets”文件，在onCreate函数中添加系统事件的订阅。
  ...
  6. 每次音频卡顿触发后，可以在Log窗口看到对系统事件数据的处理日志。
         ...
         08-19 15:06:08.827   41672-41672   A00000/com.sam...audio/testTag  com.samples.audio     I     HiAppEvent onReceive555: domain=OS
         08-19 15:06:08.827   41672-41672   A00000/com.sam...audio/testTag  com.samples.audio     I     HiAppEvent eventName=AUDIO_JANK_FRAME
         08-19 15:06:08.827   41672-41672   A00000/com.sam...audio/testTag  com.samples.audio     I     HiAppEvent eventInfo={"domain":"OS","name":"AUDIO_JANK_FRAME","eventType":1,"params":{"bundle_name":"com.samples.audio","bundle_version":"1.0.0","fault_type":"application","happen_time":3240511783,"max_frame_time":260,"process_name":"","time":1755587168818}}
