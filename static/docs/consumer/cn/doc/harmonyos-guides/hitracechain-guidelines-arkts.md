...
分布式跟踪接口由HiTraceChain模块提供，详细API请参考[分布式跟踪ArkTS API](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-hitracechain)。
...
async/await和promise/then异步任务支持HiTraceChain自动传递，示例结合[应用事件订阅](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-app-events-arkts)和[HiTraceMeter性能跟踪](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hitracemeter-guidelines-arkts)，说明分布式跟踪在ArkTS中的使用方法。
