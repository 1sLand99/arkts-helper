...
#### 限制条件
  ...
  * API version 19及以后，@Track使用在[@ComponentV2](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-componentv2)的UI中，不会引起运行时报错，但依旧不会刷新，详见[常见场景](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-v1-v2-mixusage#observed装饰的class)。
