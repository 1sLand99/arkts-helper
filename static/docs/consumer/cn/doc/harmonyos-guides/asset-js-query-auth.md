...
AUTH_TOKEN |  类型为Uint8Array。 API 20开始：长度为1-1024字节。 API 11-19：长度为148字节。 | 必选 | 用户认证通过的授权令牌。  
...
查询别名是demo_alias且需要用户认证的关键资产。示例中引入的@ohos.userIAM.userAuth用法详见[userAuth文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-useriam-userauth#start10)。
