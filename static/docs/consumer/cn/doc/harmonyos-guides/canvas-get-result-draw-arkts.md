...
通过[RenderNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-rendernode)获取可直接上屏显示的Canvas画布。
  ...
  2. 添加自定义[NodeController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-nodecontroller)。

  3. 重写自定义RenderNode的[draw()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-rendernode#draw)函数，获取Canvas进行自定义的绘制操作，即本章下文中的内容。
...
#### 离屏Canvas画布的获取与显示
  ...
  4. 重写自定义RenderNode的[draw()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-rendernode#draw)函数，在其中获取离屏Canvas进行绘制：
...
#### 示例代码
  ...
  * [图形绘制（ArkTS）](https://gitcode.com/HarmonyOS_Samples/guide-snippets/blob/HarmonyOS-feature-20250915/ArkGraphics2D/Drawing/ArkTSGraphicsDraw)
