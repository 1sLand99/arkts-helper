...
**加密**
  ...
  3. 获取加密[算法参数配置](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-huks#huksparam)。
...
文档中提供多个示例，当使用不同算法时，请注意配置对应参数。
     ...
     * 使用RSA算法加密，需要选择相对应的分组模式、填充模式以及摘要算法DIGEST，请见开发案例：RSA/ECB/PKCS1_V1_5和开发案例：RSA/ECB/OAEP/SHA256。
...
**解密**
  ...
  3. 获取解密[算法参数配置](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-huks#huksparam)。
