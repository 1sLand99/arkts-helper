...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
filter | [ColorFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-colorfilter) | 是 | 颜色滤波器。null表示清空颜色滤波器。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
filter | [MaskFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-maskfilter) | 是 | 蒙版滤镜。null表示清空蒙版滤镜。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
effect | [PathEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-patheffect) | 是 | 路径效果对象。null表示清空路径效果。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
shaderEffect | [ShaderEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-shadereffect) | 是 | 着色器对象。null表示清空着色器效果。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
shadowLayer | [ShadowLayer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-shadowlayer) | 是 | 阴影层对象。null表示清空阴影层效果。  
