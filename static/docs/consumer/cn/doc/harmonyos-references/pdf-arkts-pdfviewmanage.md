...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
offsetX | number | 是 | X坐标偏移，范围0~1，含义是0%~100%的偏移，如果总宽度是1000px，要偏移X轴500px，值是0.5。  
...
类型 | 说明  
---|---  
Promise<[image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)> | Promise对象，返回image.PixelMap类型。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<ScrollParam> | 是 | 页面滚动回调函数监听，返回ScrollParam类型数据。  
...
onProgress | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<number> | 否 | 加载文档进度回调函数，返回number类型数据，传此参数返回文档加载进度，不传不返回文档加载进度。  
  
**返回值：**

类型 | 说明  
---|---  
Promise<pdfService.[ParseResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section913412299528)> | Promise对象，返回ParseResult类型数据。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
columnCount | pdfService.[PageLayout](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section1749384210523) | 是 | 页面布局模式：单页面：1，双页面：2。  
...
类型 | 说明  
---|---  
pdfService.[PageLayout](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section1749384210523) | 页面布局模式：单页面：1，双页面：2。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
pageFit | pdfService.[PageFit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section655755325212) | 是 | 页面的适配模式。  
...
类型 | 说明  
---|---  
pdfService.[PageFit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section655755325212) | 页面的适配模式。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
horizontal | number | 是 | 双页模式下左右页面之间的间距，大于等于0，单位为vp。  
vertical | number | 否 | 连续滚动时上下页面的间距，大于等于0，单位为vp，默认值：10。  
...
---|---|---|---  
pageIndex | number | 是 | 指定页索引，0为起始页，小于总页数。  
angle | pdfService.[RotationAngle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section554915414532) | 是 | 指定页旋转角度。  
...
类型 | 说明  
---|---  
pdfService.[RotationAngle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section554915414532) | 指定页面的旋转角度。  
...
onProgress | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<number> | 否 | 保存文档回调函数进度，返回number类型数据，传此参数返回文档保存进度，不传不返回文档保存进度。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<Array<SelectedRects>> | 是 | 选中文本拖拽窗口变化回调函数监听，返回SelectedRects类型数据。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<pdfService.[PageFit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section655755325212)> | 是 | 页面适配变化回调函数监听，返回PageFit类型数据。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<number> | 是 | 页面索引变化回调函数监听，返回页面索引number类型数据。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<number> | 是 | 页面缩放回调函数监听，返回缩放值number类型数据。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<TextSelectedParam> | 是 | 页面文本被选中回调函数监听，返回选中文本TextSelectedParam类型数据。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<SelectedAnnotation> | 是 | 页面批注被选中回调函数监听，返回选中批注SelectedAnnotation类型数据。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<ImageSelectedParam> | 是 | 页面图片被选中回调函数监听，返回选中图片ImageSelectedParam类型数据。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<RedirectInfo> | 是 | Click动作回调函数监听，返回RedirectInfo类型数据。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<AnnotationChangedParam> | 是 | 批注变化时回调函数监听，返回AnnotationChangedParam类型数据。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<number> | 是 | 总页数变化回调函数监听，返回number类型总页数。  
...
搜索文本并返回匹配的总数，之前setHighlightText执行结果会失效。
...
---|---|---|---  
text | string | 是 | 搜索的文本。  
listener | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)<number> | 是 | 搜索文本回调函数监听，返回number类型的匹配总数。  
...
rect | Array<pdfService.[PdfRect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section19829174815360)> | 是 | 是 | 批注矩形区域。  
points | Array<pdfService.[PdfPoint](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section174855274363)> | 是 | 是 | 批注坐标。  
...
rectArray | Array<pdfService.[PdfRect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section19829174815360)> | 否 | 否 | 数组PdfRect类型。  
...
---|---|---|---  
pageIndex | number | 是 | 页面索引。  
rectArray | Array<pdfService.[PdfRect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section19829174815360)> | 是 | 数组PdfRect类型。  
  
#### SelectedRects

PDF页面中选定文本的矩形区域类，继承PageRects。
...
名称 | 类型 | 只读 | 可选 | 说明  
---|---|---|---|---  
imageType | pdfService.[ImageFormat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section1713111745313) | 否 | 否 | 选中的图片类型。  
buffer | ArrayBuffer | 否 | 是 | buffer参数是图像内容。如果缓冲区为空，则取消选择。  
pdfRect | pdfService.[PdfRect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfservice#section19829174815360) | 否 | 是 | 选中的图片在PDF页面的矩形区域。  
