...
类型 | 说明  
---|---  
[common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 创建的矩形对象。  
...
类型 | 说明  
---|---  
[common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 创建的矩形。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
src | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 用于拷贝的矩形。  
  
**返回值：**

类型 | 说明  
---|---  
[common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 创建的新矩形。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
rect | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 矩形对象。  
...
---|---|---|---  
rect | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 矩形对象。  
other | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 判断是否被包含的矩形对象。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
rect | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 用于计算交集的原矩形。  
other | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 用于计算交集的另一个矩形。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
rect | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 用于计算并集的原矩形。  
other | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 用于计算并集的另一个矩形。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
rect | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 用于判断的矩形对象。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
rect | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 发生偏移的矩形区域。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
rect | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 原矩形。  
other | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 用于赋值的矩形。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
rect | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 用于设置为空的矩形对象。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
rect | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 用于设置的矩形对象。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
rect | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 需要判断的原矩形。  
other | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 需要判断的另一矩形。  
