...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
length | number | 是 | 用于指定ArkTS Int32Array的长度。  
...
start | number | 是 | 源起始位置下标，如果start < 0，则会从start + Int32Array.length位置开始。  
end | number | 否 | 源终止位置下标（不包含end位置的元素），如果end < 0，则会从end + Int32Array.length位置终止。默认为ArkTS Int32Array的长度。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
predicate | [TypedArrayPredicateFn](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-types#typedarraypredicatefn)<number, Int32Array> | 是 | 用于测试的断言函数。  
...
start | number | 否 | 开始填充的索引，如果start < 0，则会从start + Int32Array.length位置开始。默认值为0。  
end | number | 否 | 结束填充的索引（不包括该元素），如果end < 0，则会到end + Int32Array.length位置结束。默认为ArkTS Int32Array的长度。  
  
**返回值：**

类型 | 说明  
---|---  
Int32Array | 填充后的Int32Array。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
predicate | [TypedArrayPredicateFn](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-types#typedarraypredicatefn)<number, Int32Array> | 是 | 用于元素过滤的断言函数。  
  
**返回值：**

类型 | 说明  
---|---  
Int32Array | 过滤后的ArkTS Int32Array对象。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
predicate | [TypedArrayPredicateFn](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-types#typedarraypredicatefn)<number, Int32Array> | 是 | 用于元素查找的断言函数。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
callbackFn | [TypedArrayForEachCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-types#typedarrayforeachcallback)<number, Int32Array> | 是 | 用于对每个元素执行的回调函数。  
...
类型 | 说明  
---|---  
string | 包含所有元素拼接成的字符串。如果ArkTS Int32Array为空，则返回空字符串。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
callbackFn | [TypedArrayMapCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-types#typedarraymapcallback)<number, Int32Array> | 是 | 回调函数。  
  
**返回值：**

类型 | 说明  
---|---  
Int32Array | 新ArkTS Int32Array对象。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
callbackFn | [TypedArrayReduceCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-types#typedarrayreducecallback)<number, number, Int32Array> | 是 | 归约函数。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
callbackFn | [TypedArrayReduceCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-types#typedarrayreducecallback)<U, number, Int32Array> | 是 | 归约函数。  
...
类型 | 说明  
---|---  
Int32Array | 反转后的ArkTS Int32Array对象。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
start | number | 否 | 开始索引，如果start < 0，则会从start + Int32Array.length位置开始。默认为0。  
end | number | 否 | 结束索引（不包括该元素），如果end < 0，则会到end + Int32Array.length位置结束。默认为ArkTS Int32Array的长度。  
...
类型 | 说明  
---|---  
Int32Array | 排序后的ArkTS Int32Array对象。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
begin | number | 否 | 开始索引，如果begin < 0，则会从begin + Int32Array.length位置开始。默认值为0。  
end | number | 否 | 结束索引（不包括该元素），如果end < 0，则会到end + Int32Array.length位置结束。默认为ArkTS Int32Array的长度。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
index | number | 是 | 要返回的Array元素的索引（从零开始），取值为整数。如果index < 0，则会访问index + Int32Array.length位置的元素。  
...
fromIndex | number | 否 | 开始搜索的索引，如果fromIndex < 0，则会从fromIndex + Int32Array.length位置开始。默认值为0。  
  
**返回值：**

类型 | 说明  
---|---  
boolean | 如果ArkTS Int32Array包含指定的元素，则返回true；否则返回false。  
