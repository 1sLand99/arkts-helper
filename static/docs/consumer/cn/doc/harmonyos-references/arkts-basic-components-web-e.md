...
名称 | 值 | 说明 | 可申请的权限  
---|---|---|---  
MidiSysex | TYPE_MIDI_SYSEX | MIDI SYSEX资源。 目前仅支持权限事件上报，MIDI设备的使用还未支持。 | 暂不支持申请使用MIDI(Musical Instrument Digital Interface)设备相关权限。  
...
SENSOR12+ | TYPE_SENSOR | 传感器资源，例如加速度传感器。 | 加速度传感器权限：ohos.permission.ACCELEROMETER、  陀螺仪传感器权限：ohos.permission.GYROSCOPE。  
