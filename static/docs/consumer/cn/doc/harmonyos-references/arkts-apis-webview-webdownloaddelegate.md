...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
callback | Callback<[WebDownloadItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-webdownloaditem)> | 是 | 下载的回调已更新。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
callback | Callback<[WebDownloadItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-webdownloaditem)> | 是 | 下载的回调已完成。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
callback | Callback<[WebDownloadItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-webdownloaditem)> | 是 | 下载回调失败。  
