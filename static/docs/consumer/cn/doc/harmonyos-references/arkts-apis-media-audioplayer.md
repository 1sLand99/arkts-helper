...
callback | function | 是 |  音频缓存事件回调方法。 [BufferingInfoType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-e#bufferinginfotype8)value值固定为0。  
