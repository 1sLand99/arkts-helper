...
名称 | 类型 | 只读 | 可选 | 说明  
---|---|---|---|---  
context | [WebNativeMessagingExtensionContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-web-webnativemessagingextensioncontext) | 否 | 否 | Web原生信息通信上下文。  
