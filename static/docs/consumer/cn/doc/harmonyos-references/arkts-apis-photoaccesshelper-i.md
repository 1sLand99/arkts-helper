...
subtype12+ | [PhotoSubtype](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-e#photosubtype12) | 否 | 是 |  图片或者视频的文件子类型。 **元服务API：** 从API version 12开始，该接口支持在元服务中使用。  
...
名称 | 类型 | 只读 | 可选 | 说明  
---|---|---|---|---  
fetchColumns | Array<string> | 否 | 否 |  检索条件，指定列名查询。 对于照片，如果该参数为空，默认查询'uri'、'media_type'、'subtype'和'display_name'，使用[get](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-photoasset#get)接口获取当前对象的其他属性时将会报错。示例：fetchColumns: ['uri', 'title']。 对于相册，如果该参数为空，默认查询'uri'和'album_name'。 **元服务API：** 从API version 20开始，该接口支持在元服务中使用。  
...
mediaAssetProgressHandler15+ | [MediaAssetProgressHandler](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/s-apis-photoaccesshelper-mediaassetprogresshandler) | 否 | 是 | 配置HDR视频转码为SDR视频时的进度级回调。  
...
uris | Array<string> | 否 | 否 | 相同[NotifyType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-e#notifytype)的所有uri，可以是PhotoAsset或Album。  
...
photoType | [PhotoType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-e#phototype) | 否 | 否 | 创建的文件类型[PhotoType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-e#phototype)，IMAGE或者VIDEO。  
subtype | [PhotoSubtype](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-e#photosubtype12) | 否 | 是 | 图片或者视频的文件子类型[PhotoSubtype](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-e#photosubtype12)，不传入时默认为DEFAULT。  
...
名称 | 类型 | 只读 | 可选 | 说明  
---|---|---|---|---  
type | [NotifyChangeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-e#notifychangetype20) | 否 | 否 | 媒体资产（图片/视频）变更的通知类型。  
...
名称 | 类型 | 只读 | 可选 | 说明  
---|---|---|---|---  
albumType | [AlbumType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-e#albumtype) | 否 | 否 | 相册类型。  
albumSubtype | [AlbumSubtype](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-e#albumsubtype) | 否 | 否 | 相册子类型。  
...
名称 | 类型 | 只读 | 可选 | 说明  
---|---|---|---|---  
type | [NotifyChangeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-e#notifychangetype20) | 否 | 否 | 相册变更的通知类型。  
