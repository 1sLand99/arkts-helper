...
schemeFilter | [ProxySchemeFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-e#proxyschemefilter15) | 否 |  与schemeFilter匹配的URL会使用代理。 默认值：MATCH_ALL_SCHEMES。  
...
参数名 | 类型 | 必填 | 说明  
---|---|---|---  
schemeFilter | [ProxySchemeFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-e#proxyschemefilter15) | 否 |  与schemeFilter匹配的URL会直接与服务器相连。 默认值：MATCH_ALL_SCHEMES  
