...
HarmonyOS 开发助手 MCP Server，为 AI 编程助手（Claude Code、Cursor、Windsurf 等）提供 ArkTS/ArkUI 文档检索和华为官方智能问答能力。
...
```bash
git clone https://github.com/LongLiveY96/harmonyos-mcp-server.git
...
```json
{
  "mcpServers": {
    "harmonyos": {
      "command": "node",
      "args": ["/path/to/harmonyos-mcp-server/dist/index.js"]
    }
  }
}
```
